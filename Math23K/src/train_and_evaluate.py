...
def evaluate_tree(input_batch, input_length, generate_nums, encoder, encoder2, predict, generate, merge, formula_enc, verify, input_lang, output_lang, num_pos, 
...
try_cnt = 0
def get_API_res(question, ww_know, wo_know, formula_prompt, nums):
    global try_cnt
...
def evaluate_tree_GPT3(input_batch, input_length, generate_nums, encoder, encoder2, predict, generate, merge, formula_enc, verify, input_lang, output_lang, num_pos, nums_list, question, ww_know, wo_know, formulas, tokenizer,
                  beam_size=5, english=False, max_length=MAX_OUTPUT_LENGTH):
    ...
    for t in range(max_length):
        ...
        while len(beams) > 0:
            ...
            step_out = get_API_res(question, ww_know, wo_know, formula_prompt, step_nums)
...
def train_verifier(input_batch, input_length, target_batch, target_length, nums_stack_batch, num_size_batch, step_batch, step_length, step_label_batch, generate_nums,
...
def evaluate_verifier(input_batch, input_length, target_batch, target_length, nums_stack_batch, num_size_batch, step_batch, step_length, step_label_batch, generate_nums,
